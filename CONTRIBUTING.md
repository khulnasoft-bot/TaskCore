...
> - This pull request adds per-adapter configuration of compaction, either auto or taskcore managed
> - That way we can get optimal performance from any adapter/provider in Taskcore
