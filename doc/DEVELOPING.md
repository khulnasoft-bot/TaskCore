...
These run the `@taskcore/ui` Storybook on port `6006` and build the static output to `ui/storybook-static/`.
...
Authenticated worktree servers also use the `TASKCORE_INSTANCE_ID` value to scope Better Auth cookie names.
