...
- email: `smoke-admin@taskcore.local`
- password: `taskcore-smoke-password`
...
1. A published `taskcore@canary` Docker install can be smoke-tested by Playwright in CI.
2. A published `taskcore@latest` Docker install can be smoke-tested by Playwright in CI.
