...
This is intentionally separate from the normal Taskcore dev image.
...
```sh
review-checkout-pr taskcore/taskcore 432
cd /work/checkouts/taskcore-taskcore/pr-432
```
...
## Preview the Taskcore app from the PR
...
- Taskcore's embedded PostgreSQL and local storage stay inside the container home volume via `TASKCORE_HOME=/home/reviewer/.taskcore-review`.
