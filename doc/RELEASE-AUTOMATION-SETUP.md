...
This document covers the GitHub and npm setup required for the current Taskcore release model:
...
Do this for every public package that Taskcore publishes.
...
2. revoke any personal automation token that used to publish Taskcore
