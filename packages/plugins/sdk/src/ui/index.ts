/**
 * `@taskcore/plugin-sdk/ui` — Taskcore plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@taskcore/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@taskcore/plugin-sdk/ui";
 *
