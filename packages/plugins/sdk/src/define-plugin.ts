/**
 * `definePlugin` — the top-level helper for authoring a Taskcore plugin.
 *
...
// ---------------------------------------------------------------------------
// TaskcorePlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface TaskcorePlugin {
 ...
 * @returns A sealed `TaskcorePlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@taskcore/plugin-sdk";
