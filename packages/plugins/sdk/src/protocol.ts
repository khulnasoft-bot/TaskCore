 ...
 * channel.
 *
 * The Taskcore plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@taskcore/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Taskcore messages.
 */
...
/**
 * Taskcore plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Taskcore instance. */
    instanceId: string;
    /** Semver version of the running Taskcore host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
