...
function requireCapability(manifest: TaskcorePluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Taskcore server runtime.
 */
