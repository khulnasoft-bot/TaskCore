import type { PluginLauncherRegistration } from "@taskcore/plugin-sdk";

export const PLUGIN_ID = "taskcore-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".taskcore-kitchen-sink-demo.txt",
} as const;
