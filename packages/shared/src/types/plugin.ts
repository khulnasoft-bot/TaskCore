...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within TaskcorePluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Taskcore host.
 *
...
export interface TaskcorePluginManifestV1 {
   ...
   */
  minimumTaskcoreVersion?: PluginMinimumHostVersion;
