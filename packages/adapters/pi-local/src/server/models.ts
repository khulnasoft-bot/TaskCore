...
import type { AdapterModel } from "@taskcore/adapter-utils";
import { asString, runChildProcess } from "@taskcore/adapter-utils/server-utils";
...
const VOLATILE_ENV_KEY_PREFIXES = ["TASKCORE_", "npm_", "NPM_"] as const;
