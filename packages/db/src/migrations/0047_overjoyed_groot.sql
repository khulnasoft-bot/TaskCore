CREATE TABLE IF NOT EXISTS "feedback_exports" (
	...
	"schema_version" text DEFAULT 'taskcore-feedback-envelope-v2' NOT NULL,
	"bundle_version" text DEFAULT 'taskcore-feedback-bundle-v2' NOT NULL,
	"payload_version" text DEFAULT 'taskcore-feedback-v1' NOT NULL,
	"payload_digest" text,
