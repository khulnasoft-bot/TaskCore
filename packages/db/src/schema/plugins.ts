...
import type { PluginCategory, PluginStatus, TaskcorePluginManifestV1 } from "@taskcore/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<TaskcorePluginManifestV1>().notNull(),
