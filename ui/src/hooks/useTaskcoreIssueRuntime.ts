...
export interface TaskcoreIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface TaskcoreIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: TaskcoreIssueRuntimeReassignment;
}

interface UseTaskcoreIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: TaskcoreIssueRuntimeSendOptions) => Promise<void>;
...
export function useTaskcoreIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseTaskcoreIssueRuntimeOptions) {
