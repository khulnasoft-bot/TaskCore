...
import { AGENT_ROLE_LABELS } from "@taskcore/shared";
...
export const help: Record<string, string> = {
  ...
  workspaceStrategy: "How Taskcore should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  ...
  bootstrapPrompt: "Only sent when Taskcore starts a fresh session. Use this for stable setup guidance that should not be repeated on every heartbeat.",
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before Taskcore adds its standard wake and workspace fields.",
