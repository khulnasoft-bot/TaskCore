...
import type { RoutineListItem, RoutineVariable } from "@taskcore/shared";
...
export function Routines() {
  ...
  const routineViewStateKey = selectedCompanyId
    ? `taskcore:routines-view:${selectedCompanyId}`
    : "taskcore:routines-view";
  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Taskcore could not update the routine.",
        tone: "error",
      });
    },
  });
  ...
  const runRoutine = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Taskcore could not start the routine run.",
        tone: "error",
      });
    },
  });
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
              ...
              <PopoverContent align="end" className="w-44 p-0">
                <div className="p-2 space-y-0.5">
                  {([
                    ...
                    <button
                      key={value}
                      className={`flex w-full items-center justify-between rounded-sm px-2 py-1.5 text-sm ${routineViewState.groupBy === value
        ...
        <TabsContent value="runs">
          <IssuesList
            ...
            viewStateKey="taskcore:routine-recent-runs-view"
        ...
        >
          ...
          <div className="shrink-0 flex flex-col gap-3 border-t border-border/60 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-sm text-muted-foreground">
              After creation, Taskcore takes you straight to trigger setup. Draft routines stay paused until you add a default agent.
            </div>
