...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@taskcore/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Taskcore file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Taskcore storage.";
