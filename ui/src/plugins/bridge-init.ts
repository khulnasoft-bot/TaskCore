 ...
 *
 * This is placed on `globalThis.__taskcorePluginBridge__` and consumed by
...
declare global {
  ...
  var __taskcorePluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__taskcorePluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__taskcorePluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
