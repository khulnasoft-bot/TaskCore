...
function installStorybookApiFixtures() {
  ...
  const currentWindow = window as typeof window & {
    __taskcoreStorybookFetchInstalled?: boolean;
  };
  if (currentWindow.__taskcoreStorybookFetchInstalled) return;

  const originalFetch = window.fetch.bind(window);
  currentWindow.__taskcoreStorybookFetchInstalled = true;
...
const preview: Preview = {
  ...
  globalTypes: {
    theme: {
      description: "Taskcore color mode",
      defaultValue: "dark",
      toolbar: {
        title: "Theme",
        icon: "mirror",
