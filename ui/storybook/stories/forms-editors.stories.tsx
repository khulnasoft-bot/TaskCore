...
import { createIssue, storybookAgents } from "../fixtures/taskcoreData";
...
function Section({
  ...
  return (
    <section className="taskcore-story__frame overflow-hidden">
      <div className="border-b border-border px-5 py-4">
        <div className="taskcore-story__label">{eyebrow}</div>
...
function StoryShell({ children }: { children: ReactNode }) {
  return (
    <div className="taskcore-story">
      <main className="taskcore-story__inner space-y-6">{children}</main>
    </div>
  );
}
...
See [the implementation notes](https://github.com/khulnasoft/taskcore).`;
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active Taskcore secret provider.",
    },
    concurrency: {
      type: "integer",
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @taskcore/ui typecheck", "pnpm build-storybook"],
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building Taskcore" }],
  name: "Board UI",
  ...
  codebase: {
    ...
    repoUrl: "https://github.com/khulnasoft/taskcore",
    repoRef: "master",
    defaultRef: "master",
    repoName: "taskcore",
    localFolder: "/Users/dotta/taskcore",
    managedFolder: "taskcore",
    effectiveLocalFolder: "/Users/dotta/taskcore",
    origin: "local_folder",
  },
  workspaces: [],
...
function FormsEditorsShowcase() {
  return (
    <StoryShell>
      <section className="taskcore-story__frame p-6">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="taskcore-story__label">Forms and editors</div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">Taskcore form controls under realistic state</h1>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for Taskcore form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;
