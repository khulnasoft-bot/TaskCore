...
import type { Agent, FeedbackVote, IssueComment } from "@taskcore/shared";
...
import { storybookAgentMap, storybookAgents } from "../fixtures/taskcoreData";
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Taskcore work: checkout, comments, linked runs, and review feedback.",
    ...
    <div className="taskcore-story">
      <main className="taskcore-story__inner space-y-6">
        <section className="taskcore-story__frame p-6">
          <div className="taskcore-story__label">Chat & Comments</div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Taskcore operational content with mixed authors, system timeline events,
...
export const CommentThreads: Story = {
  render: () => (
    <div className="taskcore-story">
      <main className="taskcore-story__inner">
        <CommentThreadMatrix />
      </main>
    </div>
  ),
